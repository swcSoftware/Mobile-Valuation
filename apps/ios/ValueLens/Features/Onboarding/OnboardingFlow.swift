        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 28) {
                VStack(alignment: .leading, spacing: 8) {
                    Text("Alpha").font(.vlDisplay).foregroundStyle(Theme.textPrimary)
                ...
                Text("Generated by Alpha • Built on Pure Fundamental SEC EDGAR Disclosures • Not Financial Advice")
